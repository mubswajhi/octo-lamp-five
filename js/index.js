...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const quizArray = [
    ...
    {
      q: ' 4.  Which country has the most volcanoes?',
      o: ['Sydney', 'Indonesia','Bangladesh', 'Japan'],
      a: 1,
    },
    {
      q: '5. What percentage of the River Nile is located in Egypt?',
      o: ['22%','44%', '34%', '75%'],
      a: 0,
    },
  ];
    ...
    quizArray.map((quizItem, index) => {
      for (let i = 0; i < 4; i++) {
        ...
        if (quizItem.a == i) {
          ...
          liElement.style.backgroundColor = "#e7b3ff"
        }
